      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-[var(--foreground)] mb-3">
            Find Creators & Merchants
          </h1>
          <p className="text-[var(--muted)] max-w-lg mx-auto">
            Discover and connect with extraordinary artists and sellers in the
            Aether community.
          </p>
        </div>
          ...
          <div className="max-w-2xl mx-auto mb-8 p-4 bg-purple-500/10 border border-purple-500/20 rounded-2xl flex items-center justify-between gap-4 animate-in fade-in slide-in-from-top-2">
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs font-bold text-purple-300">
                You are browsing as a guest. Login to see live community
                statistics.
              </p>
            </div>
            <Link
              href="/login"
              className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-[10px] font-black uppercase tracking-wider rounded-xl transition shadow-lg shadow-purple-500/20"
            >
              Login Now
            </Link>
          </div>
                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    <div className="h-16 w-16 rounded-2xl overflow-hidden border-2 border-[var(--border)] shadow-lg relative shrink-0">
                      {u.profileImageUrl ? (
                        ...
                        <div
                          className="w-full h-full flex items-center justify-center bg-gradient-to-br from-purple-600 to-indigo-700"
                          aria-hidden="true"
                        >
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        {u.roles?.includes("MERCHANT") && (
                          <FaCheckCircle
                            className="text-blue-500 dark:text-blue-400 text-xs shadow-sm"
                      ...
                      <div className="flex items-center gap-3">
                        <span className="flex items-center gap-1 text-[10px] font-bold text-[var(--muted)] uppercase tracking-tighter">
                          <FaUsers size={10} /> {u.followers?.length || 0}{" "}
                          followers
                        </span>
                      </div>
                    </div>
