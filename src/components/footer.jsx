      ...
      <div className="container-7xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          <div className="lg:col-span-1">
            <h3 className="font-bold text-black dark:text-slate-50 mb-4 text-xl">
              Aether Hub
            </h3>
            <p className="text-gray-600 dark:text-purple-300 text-sm leading-relaxed">
              Your ultimate destination for arts, music, and videos. Discover
              unique artworks, enjoy melodious tunes, and watch captivating
              videos all in one place. Join our community of creators and
              enthusiasts.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium">
              <li>
                <Link
                  href="/"
                  className="text-gray-600 dark:text-purple-300 hover:text-primary transition-colors"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="lg:col-span-2">
            <h4 className="font-bold mb-4 dark:text-slate-50">
              Payments Accepted
            </h4>
            <p className="text-sm text-gray-600 dark:text-purple-300 mb-4 font-medium">
              We support secure payments through verified mobile and card
              gateways.
            </p>
            <div className="flex items-center gap-6 bg-slate-50 dark:bg-black/20 p-4 rounded-2xl border border-slate-200 dark:border-purple-900/40 mb-6">
              ...
              <Image
                ...
                className="h-8 w-auto object-contain"
              />
              <div className="text-sm font-bold text-slate-500 dark:text-gray-400 uppercase tracking-widest">
                + COD
              </div>
            </div>

            <h4 className="font-bold mb-4 dark:text-slate-50 mt-4">
              Connect With Us
            </h4>
        ...
        <div className="text-center pt-8 border-t border-gray-200 dark:border-purple-900/40">
          <p className="text-sm font-medium dark:text-purple-300/60">
            &copy; {new Date().getFullYear()} Aether Hub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
