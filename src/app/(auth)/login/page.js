      ...
      const errorMessage =
        ...
        (!error?.response
          ...
          : typeof error === "object" &&
              ...
              !Array.isArray(error)
            ? Object.values(error).find((val) => typeof val === "string" && val)
            : null) ||
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full rounded-xl bg-purple-600 py-2 text-sm font-semibold text-white hover:bg-purple-700 transition disabled:opacity-50"
          disabled={loading}
        >
