  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3 max-h-80 overflow-y-auto pr-1 custom-scrollbar">
        {comments.length === 0 ? (
          <p className="text-gray-400 dark:text-purple-400/60 text-center py-4 text-sm italic">
          ...
          <div className="space-y-4">
            {[...comments].reverse().map((comment) => {
              ...
              const isAdmin =
                user && user.roles?.some((r) => r.toUpperCase() === "ADMIN");
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="bg-gray-50/80 dark:bg-purple-900/10 px-4 py-3 rounded-2xl rounded-tl-none inline-block max-w-[95%] shadow-sm border border-gray-100 dark:border-purple-800/30">
                      ...
                      <p className="text-gray-700 dark:text-purple-200/90 text-sm leading-relaxed whitespace-pre-wrap">
                    ...
                    <div className="flex items-center gap-4 mt-1.5 px-1">
                      ...
                      <button className="text-[10px] font-bold text-gray-500 hover:text-purple-600 transition-colors uppercase tracking-tight">
                        Like
                      </button>
                      <button
                        onClick={() => {
                      ...
                      <div className="mt-3 ml-2 pl-4 border-l-2 border-purple-200 dark:border-purple-900/40 animate-in zoom-in-95 duration-200">
                        <div className="flex gap-2">
                          <input
                            ...
                            onKeyPress={(e) =>
                              e.key === "Enter" && handleAddComment(cId)
                            }
                          />
                          <button
