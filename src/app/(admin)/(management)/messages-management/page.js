      ...
      <div className="grid grid-cols-1 gap-6">
        {messages.length > 0 ? (
          messages.map((msg) => (
            <div
              key={msg._id}
              className="bg-white dark:bg-[#160327] rounded-2xl p-6 border border-slate-200 dark:border-purple-900/40 shadow-sm hover:shadow-md transition-shadow"
            >
              ...
              <div className="border-t border-slate-100 dark:border-purple-900/20 pt-4">
                <h4 className="font-bold text-gray-800 dark:text-slate-200 mb-2 flex items-center gap-2">
                  <FaHeading size={14} className="text-primary/70" />{" "}
                  {msg.subject}
                </h4>
