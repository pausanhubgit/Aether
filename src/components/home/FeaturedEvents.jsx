      ...
      <div className="container-7xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-purple-300/80 max-w-2xl mx-auto font-secondary">
            Join our latest community events to showcase your talent, win
            exciting prizes, and connect with other creators.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {events.map((event, index) => (
            <div
              key={event._id || index}
              className="bg-white dark:bg-[#160327] rounded-2xl shadow-xl overflow-hidden transform hover:-translate-y-2 transition-all duration-300 border border-gray-100 dark:border-purple-900/40 flex flex-col h-full"
            >
              <div
                className={`h-14 ${
                  event.eventType === "Art"
              ...
              >
                ...
                <h3 className="text-white font-bold text-lg z-10 drop-shadow-md px-4 text-center truncate w-full">
                  {event.title}
                </h3>
              </div>
