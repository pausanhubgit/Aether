...
const slides = [
  {
    ...
    btn2Class:
      "border-2 border-purple-600 text-purple-600 hover:bg-purple-50 dark:border-purple-500 dark:text-purple-400 dark:hover:bg-white/5",
  },
  {
    id: 2,
    image: musicImg,
    ...
    btn1Class:
      "bg-blue-700 !text-white hover:bg-blue-800 dark:bg-blue-500 dark:hover:bg-blue-600",
    btn2Class:
      "border-2 border-blue-700 text-blue-700 hover:bg-blue-50 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900/40",
  },
  {
    id: 3,
    image: videoImg,
    ...
    btn1Class:
      "bg-teal-700 !text-white hover:bg-teal-800 dark:bg-teal-500 dark:hover:bg-teal-600",
    btn2Class:
      "border-2 border-teal-700 text-teal-700 hover:bg-teal-50 dark:border-teal-400 dark:text-teal-400 dark:hover:bg-teal-900/40",
  },
];
