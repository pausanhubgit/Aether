      ...
      <div className="mx-auto max-w-6xl space-y-12 py-12 px-4">
        ...
        <header className="text-center space-y-6">
          ...
          <p className="text-xl text-gray-600 dark:text-purple-200/80 max-w-2xl mx-auto">
            Your ultimate creative playground where imagination meets technology.
            Share, discover, and connect through arts, music, and videos.
          </p>
        </header>
        ...
        <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-[#160327] border border-transparent dark:border-purple-900/40 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-purple-100 mb-3">Stunning Arts</h3>
            <p className="text-gray-600 dark:text-purple-300/70">
              Explore a curated collection of breathtaking artworks from talented artists worldwide.
          ...
          <div className="bg-white dark:bg-[#160327] border border-transparent dark:border-purple-900/40 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-purple-100 mb-3">Rhythmic Music</h3>
            <p className="text-gray-600 dark:text-purple-300/70">
              Discover new sounds and genres. Upload your tracks, explore playlists,
              and connect with music lovers across the globe.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#160327] border border-transparent dark:border-purple-900/40 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-purple-100 mb-3">Cinematic Videos</h3>
            <p className="text-gray-600 dark:text-purple-300/70">
              Share your stories through video. From short clips to full productions,
              showcase your creativity in motion.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#160327] border border-transparent dark:border-purple-900/40 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-purple-100 mb-3">Community Driven</h3>
            <p className="text-gray-600 dark:text-purple-300/70">
              Join a vibrant community of creators. Collaborate, inspire, and grow together
          ...
          <div className="bg-white dark:bg-[#160327] border border-transparent dark:border-purple-900/40 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-purple-100 mb-3">Interactive Likes</h3>
            <p className="text-gray-600 dark:text-purple-300/70">
              Show appreciation for content you love. Track your impact and see what resonates
              with the community.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-[#160327] border border-transparent dark:border-purple-900/40 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-2xl font-semibold text-gray-800 dark:text-purple-100 mb-3">Easy Sharing</h3>
            <p className="text-gray-600 dark:text-purple-300/70">
              Share your favorite discoveries with friends. Spread creativity and build
        ...
        <section className="bg-white dark:bg-[#160327] dark:border dark:border-purple-900/40 rounded-2xl p-8 shadow-lg">
          <h2 className="text-3xl font-semibold text-gray-800 dark:text-purple-100 mb-6 text-center">What You Can Do</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-purple-100">Upload & Share Content</h4>
                  <p className="text-gray-600 dark:text-purple-300/70 text-sm">Easily upload your arts, music, and videos to share with the community.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-purple-100">Discover by Genre</h4>
                  <p className="text-gray-600 dark:text-purple-300/70 text-sm">Browse content by categories and genres to find exactly what you&apos;re looking for.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-purple-100">Personal Dashboard</h4>
                  <p className="text-gray-600 dark:text-purple-300/70 text-sm">Track your uploads, likes, and engagement through your personal dashboard.</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-purple-100">Connect with Creators</h4>
                  <p className="text-gray-600 dark:text-purple-300/70 text-sm">Follow your favorite artists and collaborate on amazing projects.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-purple-100">Interactive Engagement</h4>
                  <p className="text-gray-600 dark:text-purple-300/70 text-sm">Like, comment, and share content to show your appreciation.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-purple-100">Monetize Your Art</h4>
                  <p className="text-gray-600 dark:text-purple-300/70 text-sm">Sell your digital creations and earn from your passion.</p>
                </div>
              </div>
            </div>
          </div>
