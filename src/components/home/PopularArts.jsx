...
const Populararts = async () => {
  ...
  return (
    <section
      id="popular-arts"
      className="py-24 bg-white dark:bg-[#0d0118] overflow-hidden relative"
    >
      <div className="container-7xl">
        <div className="flex flex-col mb-16 space-y-4">
          ...
          <p className="text-slate-600 dark:text-purple-300/70 max-w-2xl font-medium leading-relaxed text-lg">
            Explore the most-liked artworks from our community, handpicked for
            their exceptional creativity and style.
          </p>
        </div>
