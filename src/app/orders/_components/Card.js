...
import DeleteAction from "./PayViaKhalti";
...
const OrderCard = ({ order, setIsUpdated }) => {
  return (
    <div className="border border-gray-300 bg-white dark:bg-[#160327] dark:border-gray-700 dark:text-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="flex flex-col gap-2 py-4 justify-between items-center bg-gray-100 dark:bg-[#160327] md:flex-row md:py-3 px-6">
