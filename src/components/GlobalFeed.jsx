...
export default function GlobalFeed({ limit = 25 }) {
  ...
  if (loading) {
    return (
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8 text-center">
        <p className="text-lg font-semibold text-[var(--foreground)]/80">Loading...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8 text-center">
        <p className="text-lg font-semibold text-[var(--foreground)]/80">Error loading feed</p>
        ...
        >
          ...
          {mediaUrl ? (
            ...
            <div className="w-full h-48 bg-purple-50 dark:bg-purple-950/20 flex items-center justify-center">
              <p className="text-gray-500 dark:text-purple-300/60">No media</p>
            </div>
          )}
          ...
          <div className="p-4">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] mb-2 line-clamp-2">{item.title || "Untitled"}</h3>
            {item.description ? (
              <p className="text-sm text-[var(--muted)] mb-3 line-clamp-3">{item.description}</p>
            ) : null}
