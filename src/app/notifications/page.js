        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
          <div>
            ...
            <p className="text-[var(--muted)] mt-1">
              Manage your activity alerts and social updates.
            </p>
          </div>
            ...
            filtered.map((notif) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`shrink-0 h-14 w-14 rounded-2xl ${meta.bg} border border-white/10 flex items-center justify-center`}
                  >
                    {notif.initials ? (
                      <span className={`text-lg font-black ${meta.text}`}>
                        {notif.initials}
                      </span>
                    ) : (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start mb-1">
                      <h3
                        className={`font-bold text-base truncate ${!notif.read ? "text-[var(--foreground)]" : "text-[var(--muted)]"}`}
                      >
                        {notif.title}
                      </h3>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      <span
                        className={`text-[10px] font-black uppercase tracking-widest ${meta.text}`}
                      >
                        {notif.type}
                      </span>
                      ...
                      {notif.fromProjectUser && (
                        <div className="flex items-center gap-2">
                          ...
                          {notif.projectName && (
                            <span className="text-[10px] font-bold text-[var(--muted)] italic">
                              #{notif.projectName}
                            </span>
                          )}
                        </div>
