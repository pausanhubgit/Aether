        ...
        <div className="relative z-10">
          {paymentState === "verifying" && (
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Verifying Payment</h2>
              <p className="text-gray-500 mt-2">Please wait while we confirm your Khalti transaction...</p>
            </div>
          )}
          ...
          {paymentState === "success" && (
            <div className="flex flex-col items-center justify-center animate-fade-in">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Payment Successful!</h2>
              <p className="text-gray-500 dark:text-gray-400 mb-8 font-medium">Your Khalti transaction has been securely processed. Your order is now confirmed.</p>
              <button
                onClick={() => router.push(`${ORDERS_ROUTE}?status=${ORDER_STATUS_CONFIRMED}`)}
          ...
          {paymentState === "failed" && (
            <div className="flex flex-col items-center justify-center animate-fade-in">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Payment Failed</h2>
              <p className="text-gray-500 dark:text-gray-400 mb-8 font-medium">There was an issue verifying your transaction. Please try again or contact support.</p>
              <button
